...
export declare const DSH_EXACT_BOM: Readonly<{
    ...
    readonly "@deepseek-ai/dsh-atomic-write": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-attachment": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-client-locale": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-client-runtime": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-client-ui-settings": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-client-ui-slots": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-client-web": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-credentials": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-home-paths": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-host-webserver": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-invariants": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-llm": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-llm-pi-ai": "0.1.0-rc.6";
    readonly "@deepseek-ai/dsh-tools": "0.1.0-rc.6";
