...
**v0.8.2** · formerly `dsh-grok-build`
...
|---|---|---|
| npm (recommended) | Current release is `0.8.2`: `dsh plugin --profile web add dsh-coding-subscription-oauth@0.8.2` | No legacy npm package was published |
