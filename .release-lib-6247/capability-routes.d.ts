...
export declare const CAPABILITY_SETTINGS_PATH = "/plugins/dsh-coding-subscription-oauth/capabilities";
export declare const CODEX_USAGE_PATH = "/plugins/dsh-coding-subscription-oauth/codex/usage";
export declare const IMAGINE_CREDENTIAL_STATUS_PATH = "/plugins/dsh-coding-subscription-oauth/imagine/credential-status";
