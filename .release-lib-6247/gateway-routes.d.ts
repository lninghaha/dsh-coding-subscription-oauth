...
export declare const GATEWAY_SETTINGS_PATH = "/plugins/dsh-coding-subscription-oauth/gateway";
export declare const GATEWAY_REVEAL_PATH = "/plugins/dsh-coding-subscription-oauth/gateway/reveal";
export declare const GATEWAY_ROTATE_PATH = "/plugins/dsh-coding-subscription-oauth/gateway/rotate";
