...
export declare const PLUGIN_HTTP_PREFIX = "/plugins/dsh-coding-subscription-oauth";
...
export declare const GROK_OAUTH_AUTH_FILENAME = ".grok-oauth-auth.json";
...
export declare const GROK_OAUTH_MODELS_CACHE_FILENAME = ".grok-oauth-models.json";
