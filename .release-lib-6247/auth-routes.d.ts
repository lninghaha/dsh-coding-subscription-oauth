...
export declare const CODING_OAUTH_STATUS_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/status";
export declare const CODING_OAUTH_LOGIN_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/login";
export declare const CODING_OAUTH_LOGIN_CODE_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/code";
export declare const CODING_OAUTH_LOGIN_CANCEL_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/cancel";
export declare const CODING_OAUTH_LOGOUT_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/logout";
export declare const CODING_OAUTH_MODELS_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/models";
