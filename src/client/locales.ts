...
export const en = {
	...
	opencodeGoApplied: "Model settings applied. Select an enabled model in DSH to start a conversation.",
	opencodeGoDirectoryLoaded: "Model directory loaded. Enable models below, then apply to make them selectable in DSH.",
	...
	opencodeGoModel: "Models",
	opencodeGoModelsHint:
		"Fetch the full directory, then enable models that match the selected protocol. Thinking levels come from known Go capabilities when the directory only returns ids.",
	opencodeGoModelsEmpty: "No models loaded yet. Fetch the directory to list checkboxes here.",
	opencodeGoSelectMatching: "Enable all matching protocol",
	opencodeGoClearModels: "Clear selection",
...
export const zh: { [Key in GrokBuildSettingsKey]: string } = {
	...
	opencodeGoApplied: "模型配置已应用，请在 DSH 中选择已启用的模型开始对话。",
	opencodeGoDirectoryLoaded: "已获取完整模型目录。请勾选要启用的模型，再应用到 DSH。",
	...
	opencodeGoModel: "模型",
	opencodeGoModelsHint: "先获取完整目录，再勾选与当前协议匹配的模型。目录若只返回 id，思维强度会用已知 Go 能力补齐。",
	opencodeGoModelsEmpty: "尚未加载模型。先获取目录，再在此勾选。",
	opencodeGoSelectMatching: "启用当前协议全部模型",
	opencodeGoClearModels: "清空选择",
