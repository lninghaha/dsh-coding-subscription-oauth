...
const STATUS_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/status";
const LOGIN_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/login";
const LOGIN_CODE_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/code";
const LOGIN_CANCEL_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/cancel";
const LOGOUT_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/logout";
const MODELS_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/models";
const SOURCES_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/sources";
const SOURCES_PREVIEW_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/sources/preview";
const SOURCES_COMMIT_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/sources/commit";
const SOURCES_CANCEL_PATH = "/plugins/dsh-coding-subscription-oauth/oauth/sources/cancel";
const CAPABILITIES_PATH = "/plugins/dsh-coding-subscription-oauth/capabilities";
const CODEX_USAGE_PATH = "/plugins/dsh-coding-subscription-oauth/codex/usage";
const IMAGINE_CREDENTIAL_PATH = "/plugins/dsh-coding-subscription-oauth/imagine/credential-status";
const GATEWAY_PATH = "/plugins/dsh-coding-subscription-oauth/gateway";
const GATEWAY_REVEAL_PATH = "/plugins/dsh-coding-subscription-oauth/gateway/reveal";
const GATEWAY_ROTATE_PATH = "/plugins/dsh-coding-subscription-oauth/gateway/rotate";
